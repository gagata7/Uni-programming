...
;;Zad4-------------------------------------------------------
(define S (stream-cons 1 (map2 * S (integers-from 2))))

(define S2 (stream-cons 1 S))

(define (partial-sums sums)
  (stream-cons (stream-car sums) (map2 + (partial-sums sums) (stream-cdr sums))))
...
(stream-ref (partial-sums S2) 0)
(stream-ref (partial-sums S2) 1)
(stream-ref (partial-sums S2) 2)
(stream-ref (partial-sums S2) 3)
(stream-ref (partial-sums S2) 4)
